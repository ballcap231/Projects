...
const housingEndpoint = 'https://7kcqlq5f16.execute-api.us-east-1.amazonaws.com/dev/get-price';

// Endpoint URL for Named Entity Recognition
const nerEndpoint = 'https://sdogg3fh40.execute-api.us-west-2.amazonaws.com/dev/ner';

// Endpoint URL for PoS tagging and dependency parsing
const parseEndpoint = 'https://v3v5p8tdr9.execute-api.us-west-2.amazonaws.com/dev/parse'; 

// S3 bucket name for image uploads
const uploadBucketName = 'image-upload-gz123';
...
const identityPoolId = 'us-west-2:dc184087-939b-4c9d-89d7-d5a6ab2c0c5e';

// Ednpoint URL for image classification with ResNet50 model
const resnet50Endpoint = 'https://bthcnlh56g.execute-api.us-west-2.amazonaws.com/dev/classify';
...
function plotImagePredictionsChart(labels, datasets) {
    ...
    imagePredictionsChart = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: 'ResNet50 Top 3 Class Probability Predictions'
            },
            scales: {
                yAxes: [{
                    ticks: {
...
function sendHousePredictionRequest() {
    ...
    $.ajax({
        ...
        url: housingEndpoint,
        headers: {
            'x-api-key': 'YTQKOFS3Xz5HQHS72aELY5uPMJKwxjlT98sdwgXU'
        },
        data: {
            medInc: $('#medInc').val(),
